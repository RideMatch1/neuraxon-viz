...
class PathSanitizer:
    def __init__(self, repo_root: Path):
        ...
        Args:
            repo_root: Path to repository root (qubic-anna-lab-public)
        """
    ...
    def _build_file_cache(self):
        ...
        for root, dirs, files in os.walk(self.repo_root):
            ...
            dirs[:] = [d for d in dirs if not d.startswith('.') and d not in ['__pycache__', 'node_modules', 'chroma_db', 'vector_db']]
